...
tl.fromTo('.cookie-container', {scale:0},{scale: 1, ease: "elastic.out(1.75, 0.4)", duration:1.6});
tl.fromTo('.cookie', {opacity:0, x: -50, rotation: "-45deg"}, {opacity:1, x: 0, rotation: '0deg'}, '<');
tl.fromTo('.text', {x:30, opacity: 0}, {x:0, opacity: 1},'<');

//Cookie jump
tl.fromTo('.cookie',{y:0, rotation:'0deg'}, {y:-20,rotation: '-20deg',yoyo: true, repeat:5});

tl.fromTo('#crumbs',{y:0}, {y:-20,yoyo: true, repeat:5},'<');
